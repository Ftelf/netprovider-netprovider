...
--
CREATE
DATABASE `netprovider` DEFAULT CHARACTER SET utf8 COLLATE utf8_czech_ci;
USE
`netprovider`;
...
(
    ...
    `BA_accountname` varchar
(
    255
) collate utf8_czech_ci NOT NULL,
    `BA_accountnumber` bigint
(
    11
) NOT NULL,
    `BA_banknumber` int
...
(
    ...
    `BA_blockedbalance` decimal
(
    11,
    2
) NOT NULL default '0.00',
    `BA_datasourcetype` int
(
    11
) NOT NULL,
    `BA_emailserver` varchar
(
    255
) collate utf8_czech_ci default NULL,
    `BA_emailusername` varchar
(
    255
) collate utf8_czech_ci default NULL,
    `BA_emailpassword` varchar
(
    255
) collate utf8_czech_ci default NULL,
    `BA_emailsender` varchar
(
    255
) collate utf8_czech_ci default NULL,
    `BA_emailsubject` varchar
(
    255
) collate utf8_czech_ci default NULL,
    PRIMARY KEY
...
(
    `BE_bankaccountentryid` int
(
    11
) NOT NULL auto_increment,
    `BE_bankaccountid` int
(
    11
) NOT NULL,
    `BE_personaccountentryid` int
(
    11
) default NULL,
...
(
    ...
    `BE_accountname` varchar
(
    255
) collate utf8_czech_ci NOT NULL,
    `BE_accountnumber` varchar
(
    255
) collate utf8_czech_ci NOT NULL,
    `BE_banknumber` int
(
    ...
    `BE_typeoftransaction` int
(
    11
) NOT NULL default '0',
    `BE_variablesymbol` bigint
(
    20
) NOT NULL default '0',
    `BE_constantsymbol` bigint
(
    20
) NOT NULL default '0',
    `BE_specificsymbol` bigint
(
    20
) NOT NULL default '0',
    `BE_amount` decimal
...
(
    255
) collate utf8_czech_ci NOT NULL default '',
    `GR_acl` int
(
    11
) NOT NULL default '0',
...
(
    ...
    `PE_personaccountid` int
(
    11
) NOT NULL,
    `PE_firstname` varchar
(
    255
) collate utf8_czech_ci NOT NULL default '',
    `PE_surname` varchar
(
    ...
    `PE_degree_prefix` varchar
(
    20
) collate utf8_czech_ci default NULL,
    `PE_degree_suffix` varchar
(
    20
) collate utf8_czech_ci default NULL,
    `PE_gender` varchar
...
(
    ...
    `PE_secondary_phone_number` varchar
(
    50
) collate utf8_czech_ci default NULL,
    `PE_icq` varchar
...
(
    ...
    `PA_variablesymbol` bigint
(
    20
) NOT NULL default '0',
    `PA_constantsymbol` bigint
(
    20
) NOT NULL default '0',
    `PA_specificsymbol` bigint
(
    20
) NOT NULL default '0',
    PRIMARY KEY
...
(
    `PN_personaccountentryid` int
(
    11
) NOT NULL auto_increment,
    `PN_bankaccountentryid` int
(
    11
) default NULL,
    `PN_personaccountid` int
(
    11
) NOT NULL,

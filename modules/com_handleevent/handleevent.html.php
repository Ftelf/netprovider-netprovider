                                ...
                                <tr class="<?php echo "row$k"; ?>">
                                    ...
                                    <td>
                                        <input type="checkbox" id="<?php echo "cb$i"; ?>" name="cid[]"
                                               value="<?php echo $handleevent->HE_handleeventid; ?>"
            ...
            <div class="padding">
                ...
                <div id="element-box">
                    <form action="index2.php" method="post" name="adminForm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="HE_notifypersonid" class="width-form">
                                                    <option value="0" <?php if ($handleEvent->HE_notifypersonid == null) {
                                                        echo 'selected="selected"';
                                                    } ?>><?php echo _("Event origin"); ?></option>
                                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="HE_notifydaysbeforeturnoff" class="width-form" size="1">
                                                    ...
                                                    for ($i = -60; $i <= 60; $i++) {
                                                        echo '<option value="' . $i . '"';
                                                        if ($handleEvent->HE_notifydaysbeforeturnoff == $i) echo ' selected="selected"';
                                                        echo ">$i</option>\n";
                                                    }
                                                    ?>
                                                </select>
                        ...
                        <input type="hidden" name="HE_handleeventid"
                               value="<?php echo $handleEvent->HE_handleeventid; ?>"/>
                        <input type="hidden" name="option" value="com_handleevent"/>
                        <input type="hidden" name="task" value=""/>
                        <input type="hidden" name="hidemainmenu" value="0"/>

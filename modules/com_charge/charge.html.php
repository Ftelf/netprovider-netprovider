                                ...
                                <tr class="<?php echo "row$k"; ?>">
                                    ...
                                    <td>
                                        <input type="checkbox" id="<?php echo "cb$i"; ?>" name="cid[]"
                                               value="<?php echo $charge->CH_chargeid; ?>"
                                    ...
                                    <table class="adminform">
                                        ...
                                        <?php if ($enableVatPayerSpecifics) { ?>
                                            <tr>
                                                ...
                                                <td><input type="text" name="CH_baseamount" class="width-form" size="40"
                                                           value="<?php echo NumberFormat::formatMoney($charge->CH_baseamount); ?>"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><?php echo _("VAT (%):"); ?></td>
                                                <td><input type="text" name="CH_vat" class="width-form" size="40"
                                                           value="<?php echo NumberFormat::formatMoney($charge->CH_vat); ?>"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><?php echo _("Amount with VAT:"); ?></td>
                                                <td><input type="text" name="CH_amount" class="width-form" size="40"
                                                           value="<?php echo NumberFormat::formatMoney($charge->CH_amount); ?>"/>
                                                </td>
                                            </tr>
                                        <?php } else { ?>
                                            <tr>
                                            ...
                                            <td>
                                                <select name="CH_currency" class="width-form" size="1">
                                                    ...
                                                    foreach (BankAccount::$CURRENCY_ARRAY as $currency) {
                                                        ...
                                                        if ($charge->CH_currency == $currency) {
                                                            echo ' selected="selected"';
                                                        }
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="typeSelect" name="CH_type" class="width-form" size="1"
                                        ...
                                        <tr>
                                            <td>
                                                <div id="internetBlock1"><?php echo _("Internet:"); ?></div>
                                            </td>
                                            <td>
                                                <div id="internetBlock2">
                                                    <select name="CH_internetid" class="width-form" size="1"
                                                            onchange="updateInternetSelect();">
                                                        <?php
                                                        foreach ($internets as $k => $internet) {
                                                            echo '<option value="' . $internet->IN_internetid . '"';
                                    ...
                                    <div id="internetBlock3">
                                        <table class="adminform">
                                            ...
                                            <tr>
                                                ...
                                                <td width="205"><input type="text" name="_IN_name" class="width-form"
                                                                       size="40" value="" disabled="disabled"/></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo _("Description:"); ?></td>
                                                <td><input type="text" name="_IN_description" class="width-form"
                                                           size="40" value="" disabled="disabled"/></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="_IN_dnl_ceil" class="width-form" size="40"
                                                           value="" disabled="disabled"/></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo _("Maximum upload:"); ?></td>
                                                <td><input type="text" name="_IN_upl_ceil" class="width-form" size="40"
                                                           value="" disabled="disabled"/></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo _("Priority:"); ?></td>
                                                <td><input type="text" name="_IN_prio" class="width-form" size="40"
                                                           value="" disabled="disabled"/></td>
                                            </tr>
                                            </tbody>
                                        </table>

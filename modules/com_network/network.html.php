...
?>
            <td id="toolbar-new-network">
              <a href="javascript:newN();">
                <span title="<?php echo _("New network"); ?>" class="icon-32-new-network"></span>
...
?>
            <td id="toolbar-edit-network">
              <a href="javascript:editN();">
                <span title="<?php echo _("Edit network"); ?>" class="icon-32-edit-network"></span>
...
?>
            <td id="toolbar-delete-network">
              <a href="javascript:removeN();">
                <span title="<?php echo _("Delete network"); ?>" class="icon-32-delete-network"></span>
...
?>
            <td id="toolbar-new-ip">
              <a href="javascript:newI();">
                <span title="<?php echo _("New IP address"); ?>" class="icon-32-new-ip"></span>
...
?>
            <td id="toolbar-edit-ip">
              <a href="javascript:editIA();">
                <span title="<?php echo _("Edit IP address"); ?>" class="icon-32-edit-ip"></span>
...
?>
            <td id="toolbar-delete-ip">
              <a href="javascript:removeI();">
                <span title="<?php echo _("Delete IP address"); ?>" class="icon-32-delete-ip"></span>
...
?>
       ...
       <td colspan="5" style="padding: 0;">
        ...
        <tbody>
        <tr>
         <td width="15%" class="title" style="background: none; background-color: #d5d5d5;"><strong><a href="<?php echo $link; ?>"><?php echo $subNetworkParsed->network . " / " . $subNetworkParsed->bitmask; ?></a></strong></td>
         <td width="15%" class="title" style="background: none; background-color: #d5d5d5;"><strong><?php echo $subNetworkParsed->netmask; ?></strong></td>
         <td width="15%" class="title" style="background: none; background-color: #d5d5d5;"><strong><?php echo $subNetworkParsed->broadcast; ?></strong></td>
         <td width="15%" class="title" style="background: none; background-color: #d5d5d5;"><strong><?php echo $freeip . " z " . $maxip . " IP volných"; ?></strong></td>
         <td width="20%" class="title" style="background: none; background-color: #d5d5d5;"><strong><?php echo $subNetwork->NE_description; ?></strong></td>
         <td width="20%" class="title" style="background: none; background-color: #d5d5d5;"><strong><?php echo $persons[$subNetwork->NE_personid]->PE_firstname . " ". $persons[$subNetwork->NE_personid]->PE_surname; ?></strong></td>
       </tr>
       </tbody>
       </table>
       </td>
  ...
  <div class="padding">
    <div id="toolbar-box">
      ...
      <div class="m">
        ...
        <div class="header icon-48-network">
          <?php echo _("IP network management"); ?>: <small><?php echo _("IP address edit"); ?></small>
        </div>
    ...
    <tr>
      <td width="360" valign="top">
        ...
        <tr>
          ...
          <td width="205"><input type="text" name="PE_firstname" class="width-form" size="40" value="<?php echo $net->network; ?>" disabled="disabled" /></td>
        </tr>
        <tr>
          <td><?php echo _("Netmask:"); ?></td>
          <td><input type="text" name="PE_surname" class="width-form" size="40" value="<?php echo $net->netmask; ?>" disabled="disabled" /></td>
        </tr>
        <tr>
          <td><?php echo _("Owner:"); ?></td>
          <td><input type="text" name="PE_surname" class="width-form" size="40" value="<?php echo $persons[$network->NE_personid]->PE_firstname . ' ' . $persons[$network->NE_personid]->PE_surname; ?>" disabled="disabled" /></td>
        </tr>
        </tbody>
        </table>
...
<?php
	if ($addresses == null) {
?>
            <input type="text" name="IP_address" class="width-form" size="40" value="<?php echo $ip->IP_address; ?>" />
<?php
	} else {
?>
...
?>
        ...
        <tr>
          ...
          <td><input type="text" name="IP_dns" class="width-form" size="40" value="<?php echo $ip->IP_dns; ?>" /></td>
        </tr>
        </tbody>
        </table>
...
<?php	if ($ip->IP_personid == null) { ?><option value="0" selected="selected"><?php echo _("- Choose owner -"); ?></option><?php	} ?>
<?php
  ...
  <div class="padding">
    ...
    <tr>
      <td width="360" valign="top">
        ...
        <tr>
          <td width="150"><?php echo _("Network address:"); ?></td>
          <td width="205"><input type="text" name="void" class="width-form" size="40" value="<?php echo $parentNetworkParsed->network; ?>" disabled="disabled" /></td>
        </tr>
        <tr>
          <td><?php echo _("Netmask:"); ?></td>
          <td><input type="text" name="void" class="width-form" size="40" value="<?php echo $parentNetworkParsed->netmask; ?>" disabled="disabled" /></td>
        </tr>
        <tr>
          <td><?php echo _("Description:"); ?></td>
          <td><input type="text" name="void" class="width-form" size="40" value="<?php echo $parentNetwork->NE_description; ?>" disabled="disabled" /></td>
        </tr>
        <tr>
          <td><?php echo _("Owner:"); ?></td>
          <td><input type="text" name="void" class="width-form" size="40" value="<?php echo $persons[$parentNetwork->NE_personid]->PE_firstname . " " . $persons[$parentNetwork->NE_personid]->PE_surname . ' (' . $persons[$parentNetwork->NE_personid]->PE_nick . ')'; ?>" disabled="disabled" /></td>
        </tr>
        </tbody>
        </table>
...
<?php	if ($network->NE_networkid == null) { ?><option value="0" selected="selected">- Vyber síť -</option><?php echo "\n"; }
		foreach($possibleNetworkArray as $possibleNetwork) {
			echo '<option value="' . $possibleNetwork. '"'; if ($possibleNetwork == $network->NE_net) echo ' selected="selected"'; echo ">$possibleNetwork</option>\n";
		}
?>
            </select>
<?php
...
?>
        ...
        <tr>
          <td><?php echo _("Description:"); ?></td>
          <td><input type="text" name="NE_description" class="width-form" size="40" value="<?php echo $network->NE_description; ?>" /></td>
        </tr>
        <tr>
          <td><?php echo _("Owner name:"); ?></td>
          <td>
            <select name="NE_personid" class="width-form">
<?php	if ($network->NE_personid == null) { ?><option value="0" selected="selected"><?php echo _("- Choose owner -"); ?></option><?php echo "\n"; } ?>
<?php
	foreach($persons as $person) {
		echo '<option value="' . $person->PE_personid . '"'; if ($network->NE_personid == $person->PE_personid) echo ' selected="selected"'; echo ">$person->PE_surname $person->PE_firstname ($person->PE_nick)</option>\n";
	}
?>
            </select>
          </td>
...
?>
    ...
    <input type="hidden" name="NE_parent_networkid" value="<?php echo $parentNetwork->NE_networkid; ?>" />
    <input type="hidden" name="NE_networkid" value="<?php echo $network->NE_networkid; ?>" />
    <input type="hidden" name="option" value="com_network" />
    <input type="hidden" name="task" value="" />
    <input type="hidden" name="hidemainmenu" value="0" />

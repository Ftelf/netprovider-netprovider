                            ...
                            <tr>
                                ...
                                <td>
                                    <table width="100%">
                                        <tr>
                                            <td colspan="3">
                                                <select data-placeholder="<?php echo _("- Choose Payments... -"); ?>"
                                                        id="chosen-payment" name="filter[CH_chargeid][]"
                                                    ...
                                                    if (count($charges) == 0) {
                                                        ...
                                                        foreach ($charges as $charge) {
                                                            ...
                                                            if (in_array($charge->CH_chargeid, $filter['CH_chargeid'])) echo ' selected="selected"';
                                                            echo ">" . $charge->CH_name . ". (" . Charge::getLocalizedPeriod($charge->CH_period) . ")</option>\n";
                                                        }
                                                    }
                                                    ?>
                                                </select>
                                                <script type="text/javascript">
                                                    $("#chosen-payment").chosen({
                                        ...
                                        <tr>
                                            ...
                                            <td rowspan="2" width="90%">
                                                <table>
                                                    <tr>
                                                        <td>Od:</td>
                                                        <td><input type="text" id="date_from" name="filter[date_from]"
                                                                   class="width-form"
                                                                   value="<?php echo $filter['date_from']; ?>" size="10"
                                                                   onchange="document.adminForm.submit( );"/></td>
                                                        <td><a href="#"
                                                               onclick="cal1x.showCalendar('anchor1x'); return false;"
                                                    ...
                                                    <tr>
                                                        <td>Do:</td>
                                                        <td><input type="text" id="date_to" name="filter[date_to]"
                                                                   class="width-form"
                                                                   value="<?php echo $filter['date_to']; ?>" size="10"
                                                                   onchange="document.adminForm.submit( );"/></td>
                                                        <td><a href="#"
                                                               onclick="cal2x.showCalendar('anchor2x'); return false;"
                                        ...
                                        <tr>
                                            <td>
                                                <select name="filter[HC_status]" class="width-form" size="1"
                                                        onchange="document.adminForm.submit( );">
                                            ...
                                            <td align="right">
                                                <select name="filter[HC_actualstate]" class="width-form" size="1"
                                                        onchange="document.adminForm.submit( );">
                            ...
                            <table class="adminlist">
                                ...
                                <tr>
                                    ...
                                    <?php if ($enableVatPayerSpecifics) { ?>
                                        <th class="title"
                                            style="border-right: 1px solid #c5c5c5;"><?php echo _("Amount with VAT"); ?></th>
                                    <?php } else { ?>
                                        <th class="title"
                                            style="border-right: 1px solid #c5c5c5;"><?php echo _("Amount"); ?></th>
                                    <?php } ?>
                                    <?php
                                    foreach ($report['dates'] as &$date) {
                                        ?>
                                        <th width="30" class="title-center title-side-shrink"
                                            style="border-right: 1px solid #c5c5c5;"><?php echo $date['DATE_STRING']; ?></th>
                                        <?php
                                    }
                                    ?>
...
//		$link = "javascript:edit('$bankAccountEntry->BE_bankaccountentryid');";
                                        ...
                                        <tr class="<?php echo "row$k"; ?>">
                                            ...
                                            foreach ($hasCharge->_dates as &$info) {
                                                ?>
                                                <td colspan="<?php echo $info['colspan']; ?>"
                                                    class="<?php echo $info['style']; ?> side-shrink"
                                                    style="border-right: 1px solid #c5c5c5;"><?php echo $info['text']; ?></td>
                                                <?php
                                            }
                                            if ($firstPersonRow) {
                                                ...
                                                <td rowspan="<?php echo $rowspan; ?>" style="text-align: center;">
                                                    <img src="<?php echo $image1Src; ?>" alt="<?php echo $image1Alt; ?>"
                                            ...
                                            <td style="text-align: center;">
                                                <img src="<?php echo $image2Src; ?>" alt="<?php echo $image2Alt; ?>"
                                                     align="middle" border="0"/>
                                            </td>
                                        </tr>
                                        <?php
...
//		$i++;
                                ...
                                ?>
                                <tr>
                                    <td class="overflow"><?php echo _("Payed"); ?></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    ...
                                    foreach ($report['dates'] as &$date) {
                                        ?>
                                        <td class="noWrap side-shrink rotate">
                                            <div>
                                                <div>
                                                    <span><?php echo NumberFormat::formatMoney($date['summary']['payed']); ?> CZK</span>
                                                </div>
                                            </div>
                                        </td>
                                        <?php
                                ...
                                <tr>
                                    ...
                                    foreach ($report['dates'] as &$date) {
                                        ...
                                        <td class="noWrap side-shrink rotate">
                                            <div>
                                                <div>
                                                    <span><?php echo NumberFormat::formatMoney($date['summary']['payedWithDelay']); ?> CZK</span>
                                                </div>
                                            </div>
                                        </td>
                                        <?php
                                ...
                                <tr>
                                    ...
                                    foreach ($report['dates'] as &$date) {
                                        ...
                                        <td class="noWrap side-shrink rotate">
                                            <div>
                                                <div>
                                                    <span><?php echo NumberFormat::formatMoney($date['summary']['pending']); ?> CZK</span>
                                                </div>
                                            </div>
                                        </td>
                                        <?php
                                ...
                                <tr>
                                    ...
                                    foreach ($report['dates'] as &$date) {
                                        ...
                                        <td class="noWrap side-shrink rotate">
                                            <div>
                                                <div>
                                                    <span><?php echo NumberFormat::formatMoney($date['summary']['delayed']); ?> CZK</span>
                                                </div>
                                            </div>
                                        </td>
                                        <?php
                                ...
                                <tr>
                                    ...
                                    foreach ($report['dates'] as &$date) {
                                        ?>
                                        <td class="noWrap side-shrink center rotate">
                                            <div>
                                                <div><span><?php echo $date['summary']['free']; ?></span></div>
                                            </div>
                                        </td>
                                        <?php
                                    }
                                ...
                                <tr>
                                    ...
                                    foreach ($report['dates'] as &$date) {
                                        ...
                                        <td class="noWrap side-shrink rotate">
                                            <div>
                                                <div>
                                                    <span><?php echo NumberFormat::formatMoney($date['summary']['payed'] + $date['summary']['payedWithDelay'] + $date['summary']['pending'] + $date['summary']['delayed']); ?> CZK</span>
                                                </div>
                                            </div>
                                        </td>
                                        <?php
                            ...
                            <tr>
                                <td width="560">
                                    <table class="adminlist">
                                        ...
                                        <tr>
                                            <td width="50"
                                                class="<?php echo PaymentReportStyles::STATUS_FINISHED_IN_TIME; ?>"></td>

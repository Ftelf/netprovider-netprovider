                                ...
                                <tr>
                                    <td id="toolbar-show-bank-list">
                                        <a href="javascript:showBankList();">
                                            <span title="<?php echo _("Bank printouts"); ?>"
                                                  class="icon-32-show-bank-list"></span>
                                    ...
                                    if ($my->GR_level == Group::SUPER_ADMINISTRATOR) {
                                        ...
                                        <td id="toolbar-edit">
                                            <a href="javascript:editBA();">
                                                <span title="<?php echo _("Edit bank account"); ?>"
                                                      class="icon-32-edit"></span>
                                    ...
                                    <td id="toolbar-edit-account-entry">
                                        <a href="javascript:editBAE();">
                                            <span title="<?php echo _("Edit account entry"); ?>"
                                                  class="icon-32-edit-account-entry"></span>
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    <table>
                                        <tr>
                                            <td class="right">
                                                <select name="BA_bankaccountid" size="1"
                                                    ...
                                                    if (count($bankAccounts) == 0) {
                                                        ...
                                                        foreach ($bankAccounts as $bankAccount) {
                                                            ...
                                                            if ($bankAccount->BA_bankaccountid == $bid) echo ' selected="selected"';
                                                            echo ">$bankAccount->BA_bankname $bankAccount->BA_accountnumber/$bankAccount->BA_banknumber</option>\n";
                                                        }
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="hidden" name="filter[date_from]" id="date_fromx"
                                                       value="<?php echo $filter['date_from']; ?>"/><input type="text"
                                                                                                           name="date_from"
                                                                                                           class="width-form"
                                                                                                           value="<?php echo $filter['date_from']; ?>"
                                                                                                           size="10"
                                                                                                           onchange="filterChange()"/>
                                            </td>
                                            <td><a href="#"
                                                   onclick="cal1x.select(document.adminForm.date_from,'anchor1x','dd.MM.yyyy'); return false;"
                                                   name="anchor1x" id="anchor1x"><img
                                                            src="images/22x22/apps/calendar.png"
                                                            style="width: 16px; height: 16px; vertical-align: middle; position: relative; top: -1px; cursor: pointer;"
                                                            alt="<?php echo _("Calendar"); ?>"/></a></td>
                                        </tr>
                                        <tr>
                                            <td>Do:</td>
                                            <td><input type="hidden" name="filter[date_to]" id="date_tox"
                                                       value="<?php echo $filter['date_to']; ?>"/><input type="text"
                                                                                                         name="date_to"
                                                                                                         class="width-form"
                                            ...
                                            <td><a href="#"
                                                   onclick="cal2x.select(document.adminForm.date_to,'anchor2x','dd.MM.yyyy'); return false;"
                            ...
                            <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td class="right">
                                                <select name="filter[entryTypeOfTransaction]" size="1"
                                                        onchange="document.adminForm.submit( );">
                                            ...
                                            <td>
                                                <select name="filter[entryStatusOfTransaction]" size="1"
                                                        onchange="document.adminForm.submit( );">
                                            ...
                                            <td>
                                                <select name="filter[entryIdentifyCodeOfTransaction]" size="1"
                                                        onchange="document.adminForm.submit( );">
                        ...
                        if (isset($bankAccounts[$bid])) {
                            ...
                            <table class="adminlist">
                                ...
                                <tr>
                                    ...
                                    <th width="2%" class="title-multiple-row"><input type="checkbox" name="toggle"
                                                                                     value=""
                                                                                     onclick="checkAll(<?php echo $pageNav->limit; ?>, 'cb');"/>
                                    </th>
                                    ...
                                    <th width="20%"
                                        class="title-multiple-row"><?php echo _("Type of transaction"); ?></th>
                                                    ...
                                                    <td width="2%">
                                                        ...
                                                        if ($bankAccountEntry->BE_status != BankAccountEntry::STATUS_PROCESSED) { ?>
                                                            <input type="checkbox" id="<?php echo "cb$i"; ?>"
                                                                   name="cid[]"
                                                                   value="<?php echo $bankAccountEntry->BE_bankaccountentryid; ?>"
            ...
            <div class="padding">
                <div id="toolbar-box">
                    ...
                    <div class="m">
                        ...
                        <div class="header icon-48-person">
                            <?php echo _("Bank account entry printout"); ?>:
                            <small><?php echo _("Bank account edit"); ?></small>
                        </div>
                ...
                <div id="element-box">
                    ...
                    <form action="index2.php" method="post" name="adminForm">
                                                ...
                                                <select name="BA_currency" class="width-form" size="1">
                                                    ...
                                                    if (!$flags['BA_accountname']) {
                                                        ...
                                                        foreach (BankAccount::$CURRENCY_ARRAY as $currency) {
                                                            ...
                                                            if ($bankAccount->BA_currency == $currency) echo ' selected="selected"';
                                ...
                                <td width="360" valign="top">
                                    <table class="adminform">
                                        ...
                                        <tr>
                                            ...
                                            <td width="205"><input type="text" name="BA_startbalance" class="width-form"
                                                                   size="40"
                                                                   value="<?php echo NumberFormat::formatMoney($bankAccount->BA_startbalance); ?>"<?php if (!$flags['BA_startbalance']) echo ' disabled="disabled"'; ?> />
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="adminform">
                                        ...
                                        <tr>
                                            ...
                                            <td width="205"><input type="text" name="BA_emailserver" class="width-form"
                                                                   size="40"
                                                                   value="<?php echo $bankAccount->BA_emailserver; ?>"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Username:"); ?></td>
                                            <td><input type="text" name="BA_emailusername" class="width-form" size="40"
                                                       value="<?php echo $bankAccount->BA_emailusername; ?>"/></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Password:"); ?></td>
                                            <td><input type="text" name="BA_emailpassword" class="width-form" size="40"
                                                       value="<?php echo $bankAccount->BA_emailpassword; ?>"/></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Sender address:"); ?></td>
                                            <td><input type="text" name="BA_emailsender" class="width-form" size="40"
                                                       value="<?php echo $bankAccount->BA_emailsender; ?>"/></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Subject:"); ?></td>
                                            <td><input type="text" name="BA_emailsubject" class="width-form" size="40"
                                                       value="<?php echo $bankAccount->BA_emailsubject; ?>"/></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </td>
                        ...
                        <input type="hidden" name="BA_bankaccountid"
                               value="<?php echo $bankAccount->BA_bankaccountid; ?>"/>
                        <input type="hidden" name="option" value="com_bankaccount"/>
                        <input type="hidden" name="task" value=""/>
                        <input type="hidden" name="hidemainmenu" value="0"/>
                    </form>
            ...
            <div class="padding">
                <div id="toolbar-box">
                    ...
                    <div class="m">
                                    ...
                                    if ($my->GR_level == Group::SUPER_ADMINISTRATOR) {
                                        ...
                                        <td id="toolbar-upload-bank-lists">
                                            <a href="javascript:submitbutton('uploadBankLists');">
                                                <span title="<?php echo _("Upload new printout"); ?>"
                                                      class="icon-32-upload-bank-lists"></span>
                                        ...
                                        if ($bankAccount->BA_datasource == BankAccount::DATASOURCE_EMAIL_CONTENT) {
                                            ...
                                            <td id="toolbar-download-bank-lists">
                                                <a href="javascript:submitbutton('downloadBankLists');">
                                                    <span title="<?php echo _("Download new printouts"); ?>"
                                                          class="icon-32-download-bank-lists"></span>
                                        ...
                                        <td id="toolbar-process-bank-lists">
                                            <a href="javascript:submitbutton('processBankLists');">
                                                <span title="<?php echo _("Run import"); ?>"
                                                      class="icon-32-process-bank-lists"></span>
                                        ...
                                        <td id="toolbar-process-entries">
                                            <a href="javascript:submitbutton('processEntries');">
                                                <span title="<?php echo _("Entries workout"); ?>"
                                                      class="icon-32-process-entries"></span>
                        ...
                        <div class="header icon-48-bank-account">
                            <?php echo _("Bank account entry printout"); ?>:
                            <small><?php echo _("Printouts list"); ?></small>
                        </div>
            ...
            <div class="padding">
                <div id="toolbar-box">
                    ...
                    <div class="m">
                        ...
                        <div class="header icon-48-bank-account">
                            <?php echo _("Bank account entry printout"); ?>:
                            <small><?php echo _("Identification"); ?></small>
                        </div>
                ...
                <div id="element-box">
                    <form action="index2.php" method="post" name="adminForm">
                                ...
                                <td width="360" valign="top">
                                    <table class="adminform">
                                        ...
                                        <tr>
                                            ...
                                            <td width="205"><input type="text" name="BE_datetime" class="width-form"
                                                                   size="40"
                                                                   value="<?php echo $datetime->getFormattedDate(DateUtil::FORMAT_FULL); ?>"
                                                                   disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Write off date:"); ?></td>
                                            <td><input type="text" name="BE_writeoff_date" class="width-form" size="40"
                                                       value="<?php echo $writeoffDate->getFormattedDate(DateUtil::FORMAT_DATE); ?>"
                                                       disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><?php echo _("Bank registration number:"); ?></td>
                                            <td><input type="text" name="BE_banknumber" class="width-form" size="40"
                                                       value="<?php echo $bankAccountEntry->BE_banknumber; ?>"
                                                       disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="BE_constantsymbol" class="width-form" size="40"
                                                       value="<?php echo $bankAccountEntry->BE_constantsymbol; ?>"
                                                       disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Specific symbol:"); ?></td>
                                            <td><input type="text" name="BE_specificsymbol" class="width-form" size="40"
                                                       value="<?php echo $bankAccountEntry->BE_specificsymbol; ?>"
                                                       disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Amount:"); ?></td>
                                            <td><input type="text" name="BE_amount" class="width-form" size="40"
                                                       value="<?php echo NumberFormat::formatMoney($bankAccountEntry->BE_amount); ?>"
                                                       disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Fee:"); ?></td>
                                            <td><input type="text" name="BE_charge" class="width-form" size="40"
                                                       value="<?php echo NumberFormat::formatMoney($bankAccountEntry->BE_charge); ?>"
                                                       disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="BE_typeoftransaction" class="width-form"
                                                       size="40"
                                                       value="<?php echo BankAccountEntry::getLocalizedType($bankAccountEntry->BE_typeoftransaction); ?>"
                                                       disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                ...
                                <td width="360" valign="top">
                                    ...
                                    <div id="PN_personaccountidBlock" style="display: none;">
                                        <table class="adminform" id="userTable">
                                            ...
                                            <tr>
                                                <td width="150"
                                                    style="border-bottom: 1px solid black;"><?php echo _("User account:"); ?></td>
                                                <td width="205" colspan="2" style="border-bottom: 1px solid black;">
                                                    <select name="PN_personaccountid" class="width-form"
                                                            onchange="onChangeUserAccount();">
                                                        <?php
                                                        if ($bankAccountEntry->BE_personaccountentryid == null) {
                                                            ?>
                                                            <option value="0"
                                                                    selected="selected"><?php echo _("- Select user's account -"); ?></option><?php echo "\n";
                                                        }

                                                        foreach ($persons as $person) {
                                                            ?>
                                                            <option value="<?php echo $person->PA_personaccountid; ?>"><?php echo $person->PE_surname . " " . $person->PE_firstname;
                                                                echo ($person->PE_nick) ? ", " . $person->PE_nick : ""; ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
                        ...
                        <input type="hidden" name="BA_bankaccountid"
                               value="<?php echo $bankAccountEntry->BE_bankaccountid; ?>"/>
                        <input type="hidden" name="BE_bankaccountentryid"
                               value="<?php echo $bankAccountEntry->BE_bankaccountentryid; ?>"/>
                        <input type="hidden" name="option" value="com_bankaccount"/>
                        <input type="hidden" name="task" value=""/>
                        <input type="hidden" name="hidemainmenu" value="0"/>
                                ...
                                <td width="360" valign="top">
                                    ...
                                    foreach ($bankAccountEntries as $bankAccountEntry) {
                                        ...
                                        <table class="adminform">
                                            ...
                                            <tr>
                                                <td><?php echo _("Write off date:"); ?></td>
                                                <td><input type="text" name="BE_writeoff_date" class="width-form"
                                                           size="40"
                                                           value="<?php echo $writeoffDate->getFormattedDate(DateUtil::FORMAT_DATE); ?>"
                                                           disabled="disabled"/></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td><?php echo _("Account number:"); ?></td>
                                                <td><input type="text" name="BE_accountnumber" class="width-form"
                                                           size="40"
                                                           value="<?php echo $bankAccountEntry->BE_accountnumber; ?>"
                                                           disabled="disabled"/></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td><?php echo _("Variable symbol:"); ?></td>
                                                <td><input type="text" name="BE_variablesymbol" class="width-form"
                                                           size="40"
                                                           value="<?php echo $bankAccountEntry->BE_variablesymbol; ?>"
                                                           disabled="disabled"/></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo _("Constant symbol:"); ?></td>
                                                <td><input type="text" name="BE_constantsymbol" class="width-form"
                                                           size="40"
                                                           value="<?php echo $bankAccountEntry->BE_constantsymbol; ?>"
                                                           disabled="disabled"/></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo _("Specific symbol:"); ?></td>
                                                <td><input type="text" name="BE_specificsymbol" class="width-form"
                                                           size="40"
                                                           value="<?php echo $bankAccountEntry->BE_specificsymbol; ?>"
                                                           disabled="disabled"/></td>
                                            </tr>

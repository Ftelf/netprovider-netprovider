                        ...
                        <table>
                            <tr>
                                ...
                                <td align="right">
                                    <select name="filter[log_level]" size="1" onchange="document.adminForm.submit( );">
                                        ...
                                        foreach (Log::$LEVEL_ARRAY as $logLevel) {
                                            ...
                                            if ($filter['log_level'] == $logLevel) echo ' selected="selected"';
                                            echo ">" . Log::getLocalizedLevel($logLevel) . "</option>";
                                        }
                                        ?>
                                    </select>
                                </td>
                                ...
                                <td><a href="#"
                                       ...
                                       name="anchor1x" id="anchor1x"><img src="images/22x22/apps/calendar.png"
                                ...
                                <td><a href="#"
                                       ...
                                       name="anchor2x" id="anchor2x"><img src="images/22x22/apps/calendar.png"
                                                                          style="width: 16px; height: 16px; vertical-align: middle; position: relative; top: -2px; cursor: pointer;"
                                                                          alt="<?php echo _("Calendar"); ?>"/></a></td>
                                <td align="right">

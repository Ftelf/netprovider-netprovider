                                ...
                                <td valign="top">
                                    <div class="tab-page" id="modules-cpanel-myperson">
                                            ...
                                            <table class="adminlist">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="9%" class="title"
                                                        colspan="2"><?php echo _("Actual status"); ?></th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <?php
                                                ...
                                                foreach ($hasCharges as $hasCharge) {
                                                    ...
                                                    <tr class="row0">
                                                        ...
                                                        <td align="left">
                                                            <img src="<?php echo $imageActualState; ?>"
                                                                 alt="<?php echo $altActualState; ?>" align="middle"
                                                                 border="0"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td colspan="<?php echo $chargesTableColspan; ?>">
                                                            <table class="adminlist">
                                                                ...
                                                                <tr>
                                                                    <th width="2%" class="title">#</th>
                                                                    <th width="8%"
                                                                        class="title"><?php echo _("Date/period"); ?></th>
                                                                    <th width="8%"
                                                                        class="title"><?php echo _("Date of payment"); ?></th>
                                                                    <th width="8%"
                                                                        class="title"><?php echo _("Tolerance till"); ?></th>
                                                                    <th width="7%"
                                                                        class="title"><?php echo _("Write off date"); ?></th>
                                                                    <th width="7%"
                                                                        class="title"><?php echo _("Delay in days"); ?></th>
                                                                    <th width="10%"
                                                                        class="title"><?php echo _("Status"); ?></th>
                                                                    <?php if ($enableVatPayerSpecifics) { ?>
                                                                        <th width="10%"
                                                                            class="title"><?php echo _("Amount without VAT"); ?></th>
                                                                        <th width="10%"
                                                                            class="title"><?php echo _("VAT (%)"); ?></th>
                                                                        <th width="10%"
                                                                            class="title"><?php echo _("Amount with VAT"); ?></th>
                                                                    <?php } else { ?>
                                                                        <th width="10%"
                                                                            class="title"><?php echo _("Amount"); ?></th>
                                                                    <?php } ?>
                                                                    <th width="10%"
                                                                        class="title"><?php echo _("Currency"); ?></th>
                                                                </tr>
                                                                </thead>
                                                                <tbody>
                                                                <?php
                                        ...
                                        <div class="tab-page" id="module04"><h2
                                                    class="tab"><?php echo _("Incoming payments"); ?></h2>
                                            ...
                                            <table class="adminlist">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="10%"
                                                        class="title"><?php echo _("Account number"); ?></th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <?php
                                        ...
                                        <div class="tab-page" id="module05"><h2
                                        ...
                                        <div class="tab-page" id="module06"><h2
                                                    class="tab"><?php echo _("Networks"); ?></h2>
                                            <script type="text/javascript">tabPanePerson1.addTabPage(document.getElementById("module06"));</script>
                                            <table class="adminlist">
                                                <thead>
                                                <tr>
                                                    <th class="title"
                                                        width="150"><?php echo _("Network address"); ?></th>
                                        ...
                                        <div class="tab-page" id="module07"><h2
                                                    class="tab"><?php echo _("Messages"); ?></h2>
                                        ...
                                        <div class="tab-page" id="module08"><h2
                                                    class="tab"><?php echo _("Data traffic"); ?></h2>
                                    ...
                                    <div class="tab-page" id="modules-cpanel-editmyprofile">
                                        ...
                                        <div class="tab-page" id="module01"><h2
                                            ...
                                            <table class="adminform">
                                                ...
                                                <tr>
                                                    <td width="150"><?php echo _("Login name:"); ?></td>
                                                    <td><input type="text" name="void" class="width-form"
                                                               disabled="disabled" size="20"
                                                               value="<?php echo $person->PE_username; ?>"/></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo _("Password:"); ?></td>
                                                    <td><input type="password" name="PE_password1" class="width-form"
                                                               size="20" value="" maxlength="255"/></td>
                                                </tr>
                                                <tr>

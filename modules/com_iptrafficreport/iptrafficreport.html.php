                    ...
                    <form action="index2.php" method="post" name="adminForm" enctype="multipart/form-data">
                        <table>
                            <tr>
                                ...
                                <td align="right">
                                    <select name="filter[period]" class="width-form" size="1"
                                        ...
                                        foreach ($report['options'] as $k => $period) {
                                            echo '<option value="' . $k . '"';
                                            if ($filter['period'] == $k) echo 'selected="selected"';
                                            echo ">$period</option>";
                                        }
                                        ?>
                                    </select>
                                ...
                                <td><input type="checkbox" name="filter[show_rate]" value="checked"
                                           onChange="document.adminForm.submit();" <?php if ($filter['show_rate'] == 'checked') echo 'checked="checked"'; ?> /><?php echo _("Show average rate"); ?>
                                </td>
                            </tr>
                        </table>
                        <table class="adminlist">
                            ...
                            <tr>
                                ...
                                ?>
                                <th width="20" class="title"><a href="#"
                                                                onclick="sortChange('<?php echo IpDAO::data; ?>', 'ASC')">#</a>
                                </th>
                                <th class="title"><a href="#"
                                                     onclick="sortChange('<?php echo IpDAO::PE_surname; ?>', 'ASC')"><?php echo _("Surname"); ?></a>
                                </th>
                                <th class="title"><a href="#"
                                                     onclick="sortChange('<?php echo IpDAO::PE_firstname; ?>', 'ASC')"><?php echo _("Firstname"); ?></a>
                                </th>
                                <th class="title"><a href="#"
                                                     onclick="sortChange('<?php echo IpDAO::PE_nick; ?>', 'ASC')"><?php echo _("Nickname"); ?></a>
                                </th>
                                <th class="title"><a href="#"
                                                     onclick="sortChange('<?php echo IpDAO::IP_address; ?>', 'ASC')"><?php echo _("IP address"); ?></a>
                                </th>
                                <?php

                                ...
                                <tr>
                                    <td id="toolbar-create-blank-charges">
                                        <a href="javascript:createBlankCharges();">
                                            <span title="<?php echo _("Create blank charges"); ?>"
                                                  class="icon-32-create-blank-charges"></span>
                                    ...
                                    <td id="toolbar-proceed-charges">
                                        <a href="javascript:proceedCharges();">
                                            <span title="<?php echo _("Pay payables"); ?>"
                                                  class="icon-32-proceed-charges"></span>
                    ...
                    <form action="index2.php" method="post" name="adminForm">
                        <table>
                            <tr>
                                ...
                                <td align="right">
                                    <select name="filter[bilance]" class="width-form" size="1"
                                            onchange="document.adminForm.submit();">
                ...
                <div id="toolbar-box">
                    ...
                    <div class="m">
                                ...
                                <tr>
                                    <td id="toolbar-new">
                                        <a href="javascript:submitbutton('newPAE');">
                                            <span title="<?php echo _("New payment"); ?>"
                                                  class="icon-32-proceed-new-payment"></span>
                        ...
                        <div class="header icon-48-person">
                            <?php echo _("User's accounts"); ?>:
                            <small><?php echo _("User's account detail"); ?></small>
                        </div>
                                ...
                                <tr class="<?php echo "row$k"; ?>">
                                    ...
                                    <td>
                                        <select size="1" style="width: 100px;"
                                                onchange="personAccountEntryAction(this, <?php echo $personAccountEntry->PN_personaccountentryid; ?>);">
                                ...
                                <tr class="row0">
                                    ...
                                    <td>
                                        ...
                                        if ($hasCharge->HC_actualstate == HasCharge::ACTUALSTATE_ENABLED) { ?>
                                            <img src="images/16x16/actions/agt_action_success.png" alt="active"
                                                 align="middle" border="0"/>
                                            <?php
                                        } else if ($hasCharge->HC_actualstate == Hascharge::ACTUALSTATE_DISABLED) { ?>
                                            <img src="images/16x16/actions/agt_stop.png" alt="removed" align="middle"
                                                 border="0"/>
                                            <?php
                                        }
                                        ?>
                                        ...
                                        <table class="adminlist">
                                            ...
                                            foreach ($hasCharge->_chargeEntries as $chargeEntry) {
                                                ...
                                                <tr class="<?php echo "row$k2"; ?>">
                                                    ...
                                                    <td>
                                                        <select size="1" style="width: 100px;"
                                                                onchange="changeEntryAction(this, <?php echo $chargeEntry->CE_chargeentryid; ?>);">
                                                            <option value="0" selected="selected"></option>
                                                            <?php
            ...
            <div class="padding">
                ...
                <div id="element-box">
                    <form action="index2.php" method="post" name="adminForm">
                                ...
                                <td width="480">
                                    <table class="adminform">
                                        ...
                                        <tr>
                                            <td width="250"><?php echo _("Name:"); ?></td>
                                            <td width="205"
                                                colspan="2"><?php echo $person->PE_firstname . ' ' . $person->PE_surname; ?></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Currency:"); ?></td>
                                        ...
                                        <tr>
                                            <td><?php echo _("Variable symbol:"); ?></td>
                                            <td><input type="text" name="PA_variablesymbol" class="width-form" size="40"
                                                       value="<?php echo $personAccount->PA_variablesymbol; ?>" <?php if (!$personAccount->PA_variablesymbol) echo 'disabled="disabled"'; ?> />
                                            </td>
                                            <td width="20"><input type="checkbox" name="_CB_PA_variablesymbol" value="1"
                                                                  onchange="vs(this.checked);" <?php if ($personAccount->PA_variablesymbol) echo 'checked="checked"'; ?>/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Constant symbol:"); ?></td>
                                            <td><input type="text" name="PA_constantsymbol" class="width-form" size="40"
                                                       value="<?php echo $personAccount->PA_constantsymbol; ?>" <?php if (!$personAccount->PA_constantsymbol) echo 'disabled="disabled"'; ?> />
                                            </td>
                                            <td><input type="checkbox" name="_CB_PA_constantsymbol" value="1"
                                                       onchange="cs(this.checked);" <?php if ($personAccount->PA_constantsymbol) echo 'checked="checked"'; ?>/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Specific symbol:"); ?></td>
                                            <td><input type="text" name="PA_specificsymbol" class="width-form" size="40"
                                                       value="<?php echo $personAccount->PA_specificsymbol; ?>" <?php if (!$personAccount->PA_specificsymbol) echo 'disabled="disabled"'; ?> />
                                            </td>
                                            <td><input type="checkbox" name="_CB_PA_specificsymbol" value="1"
                                                       onchange="ss(this.checked);" <?php if ($personAccount->PA_specificsymbol) echo 'checked="checked"'; ?>/>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <input type="hidden" name="PE_personid" value="<?php echo $person->PE_personid; ?>"/>
                        <input type="hidden" name="PA_personaccountid"
                               value="<?php echo $personAccount->PA_personaccountid; ?>"/>
                        <input type="hidden" name="option" value="com_personaccount"/>
                        <input type="hidden" name="task" value=""/>
                        <input type="hidden" name="hidemainmenu" value="0"/>
                    </form>
                                ...
                                <td width="360" valign="top">
                                    <table class="adminform">
                                        ...
                                        <tr>
                                            ...
                                            <td width="205"><input type="text" name="PN_amount" class="width-form"
                                                                   size="40"
                                                                   value="<?php echo $personAccountEntry->PN_amount; ?>"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Date:"); ?></td>
                                            <td>
                                                <input type="text" name="PN_date" class="width-form-button"
                                                       value="<?php echo $date->getFormattedDate(DateUtil::FORMAT_DATE); ?>"
                                                       size="15"/>
                                                <a href="#"
                                                   onclick="cal1x.select(document.adminForm.PN_date,'anchor1x','dd.MM.yyyy'); return false;"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="PN_comment" class="width-form" size="40"
                                                       value="<?php echo $personAccountEntry->PN_comment; ?>"/></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </td>

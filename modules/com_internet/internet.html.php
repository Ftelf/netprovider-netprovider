                                ...
                                <tr class="<?php echo "row$k"; ?>">
                                    ...
                                    <td>
                                        <input type="checkbox" id="<?php echo "cb$i"; ?>" name="cid[]"
                                               value="<?php echo $internet->IN_internetid; ?>"
                                ...
                                <td width="460" valign="top">
                                    <table class="adminform">
                                        ...
                                        <tr>
                                            ...
                                            <td width="205"><input type="text" name="IN_dnl_rate" class="inputbox"
                                                                   size="40"
                                                                   value="<?php echo ($internet->IN_dnl_rate == -1) ? "" : $internet->IN_dnl_rate; ?>" <?php if ($internet->IN_dnl_rate == -1) echo 'disabled="disabled"'; ?>/>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="IN_upl_rate" class="inputbox" size="40"
                                                       value="<?php echo ($internet->IN_upl_rate == -1) ? "" : $internet->IN_upl_rate; ?>" <?php if ($internet->IN_upl_rate == -1) echo 'disabled="disabled"'; ?>/>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3"><input type="text" name="IN_dnl_ceil" class="inputbox"
                                                                   size="40"
                                                                   value="<?php echo $internet->IN_dnl_ceil; ?>"/></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Maximum upload (kbps):"); ?></td>
                                            <td colspan="3"><input type="text" name="IN_upl_ceil" class="inputbox"
                                                                   size="40"
                                                                   value="<?php echo $internet->IN_upl_ceil; ?>"/></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <select name="IN_prio" class="inputbox" size="1">
                                                    ...
                                                    for ($i = 0; $i < 10; $i++) {
                                                        echo '<option value="' . $i . '"';
                                                        if ($internet->IN_prio == $i) echo ' selected="selected"';
                                                        echo ">$i</option>\n";
                                                    }
                                                    ?>
                                                </select>

                                ...
                                <td align="right">
                                    <select name="filter[group]" size="1" onchange="document.adminForm.submit( );">
                                        ...
                                        foreach ($groups as $group) {
                                            echo '<option value="' . $group->GR_groupid . '"';
                                            if ($filter['group'] == $group->GR_groupid) echo ' selected="selected"';
                                            echo ">$group->GR_name</option>";
                                        }
                                        ?>
                                    </select>
                                </td>
                        ...
                        <table class="adminlist">
                            ...
                            foreach ($persons as $person) {
                                ...
                                <tr class="<?php echo "row$k"; ?>">
                                    ...
                                    <td>
                                        <input type="checkbox" id="<?php echo "cb$i"; ?>" name="cid[]"
                                               value="<?php echo $person->PE_personid; ?>"
                            ...
                            <tr>
                                <td valign="top" width="365">
                                    <table class="adminform">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="PE_firstname" class="width-form" size="40"
                                                       value="<?php echo $person->PE_firstname; ?>" maxlength="255"/>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="PE_birthdate" class="width-form-button"
                                                       value="<?php echo $birthDate->getFormattedDate(DateUtil::FORMAT_DATE); ?>"
                                ...
                                <td valign="top">
                                    <div class="tab-page" id="modules-cpanel-person">
                                        ...
                                        <div class="tab-page" id="module01"><h2
                                            ...
                                            <table class="adminform">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="PE_username" class="width-form"
                                                               size="20" value="<?php echo $person->PE_username; ?>"
                                                               maxlength="255" autocomplete="new-password"/></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo _("Password:"); ?></td>
                                                    <td><input type="password" name="PE_password1" class="width-form"
                                                               size="20" value="<?php echo $person->PE_password; ?>"
                                                               maxlength="255" autocomplete="new-password"/></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo _("Password confirmation:"); ?></td>
                                                    <td><input type="password" name="PE_password2" class="width-form"
                                                               size="20" value="<?php echo $person->PE_password; ?>"
                                                               maxlength="255" autocomplete="new-password"/></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="PE_groupid" class="width-form">
                                                            ...
                                                            foreach ($groups as $group) {
                                                                echo '<option value="' . $group->GR_groupid . '"';
                                                                if ($person->PE_groupid == $group->GR_groupid) echo ' selected="selected"';
                                                                echo ">$group->GR_name</option>\n";
                                                            }
                                                            ?>
                                                        </select>
                                        ...
                                        <div class="tab-page" id="module02"><h2
                                                    class="tab"><?php echo _("Role"); ?></h2>
                                            ...
                                            <table class="adminform">
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="middle" width="50">
                                                        <a class="text-button" href="javascript:removeRole();"><img
                                                                    src="images/16x16/actions/delete.png"
                                                                    alt="<?php echo _("Remove"); ?>" align="middle"
                                                                    border="0"/></a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="javascript:addRole();" class="text-button"
                                                           style="float: left;"><img
                                                                    src="images/16x16/actions/edit_add.png"
                                                                    alt="<?php echo _("Add"); ?>" align="middle"
                                                                    border="0"/></a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                        ...
                                        <div class="tab-page" id="module03"><h2
                                                    class="tab"><?php echo _("Payments"); ?></h2>
                                            ...
                                            <table class="adminlist">
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($enableVatPayerSpecifics) { ?>
                                                        <th width="9%"
                                                            class="title"><?php echo _("Amount without VAT"); ?></th>
                                                        <th width="9%" class="title"><?php echo _("VAT (%)"); ?></th>
                                                        <th width="9%"
                                                            class="title"><?php echo _("Amount with VAT"); ?></th>
                                                    <?php } else { ?>
                                                    ...
                                                    <tr class="<?php echo "row$k"; ?>">
                                                        ...
                                                        <td>
                                                            <select style="width: 100%;" size="1"
                                                                    onchange="<?php echo $linkEditHasChargeOption; ?>">
                                                ...
                                                <tr class="<?php echo "irow$k"; ?>">
                                                    <td align="right" colspan="<?php echo $chargesColspan; ?>">
                                                        <a id="newHasChargeClick" class="text-button"
                                                           href="javascript:showHasCharge();">
                                                            <?php echo _("New payment"); ?>
                                                        </a>

                                                        <div id="newHasChargeBlock" style="display: none;">
                                                            <select name="CH_chargeid"
                                                            ...
                                                            <a class="text-button" href="javascript:newHasCharge();"
                                        ...
                                        <div class="tab-page" id="module04"><h2
                                                    class="tab"><?php echo _("IP addresses"); ?></h2>
                                ...
                                <td width="360" valign="top">
                                    <table class="adminform">
                                        ...
                                        <tr>
                                            ...
                                            <td width="205"><input type="text" name="_CH_name" class="width-form"
                                                                   size="40" value="<?php echo $charge->CH_name; ?>"
                                                                   disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Service description:"); ?></td>
                                            <td><input type="text" name="_CH_name" class="width-form" size="40"
                                                       value="<?php echo $charge->CH_description; ?>"
                                                       disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Write off:"); ?></td>
                                            <td><input type="text" name="_CH_name" class="width-form" size="40"
                                                       value="<?php echo Charge::getLocalizedPeriod($charge->CH_period); ?>"
                                                       disabled="disabled"/></td>
                                        </tr>
                                        <?php if ($enableVatPayerSpecifics) { ?>
                                            <tr>
                                                ...
                                                <td><input type="text" name="_CH_name" class="width-form" size="40"
                                                           value="<?php echo $charge->CH_baseamount; ?>"
                                                           disabled="disabled"/></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo _("VAT (%):"); ?></td>
                                                <td><input type="text" name="_CH_name" class="width-form" size="40"
                                                           value="<?php echo $charge->CH_vat; ?>" disabled="disabled"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><?php echo _("Amount with VAT:"); ?></td>
                                                <td><input type="text" name="_CH_name" class="width-form" size="40"
                                                           value="<?php echo $charge->CH_amount; ?>"
                                                           disabled="disabled"/></td>
                                            </tr>
                                        <?php } else { ?>
                                            <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="_CH_name" class="width-form" size="40"
                                                       value="<?php echo $charge->CH_currency; ?>" disabled="disabled"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Tolerance in days:"); ?></td>
                                            <td><input type="text" name="_CH_name" class="width-form" size="40"
                                                       value="<?php echo $charge->CH_tolerance; ?>"
                                                       disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo _("Type:"); ?></td>
                                            <td><input type="text" name="_CH_name" class="width-form" size="40"
                                                       value="<?php echo Charge::getLocalizedType($charge->CH_type); ?>"
                                                       disabled="disabled"/></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="adminform">
                                        ...
                                        <tr>
                                            ...
                                            <td width="205">
                                                ...
                                                <input type="text" name="HC_datestart"
                                                       value="<?php echo $dateStart->getFormattedDate(DateUtil::FORMAT_MONTHLY); ?>"
                                                       class="width-form-button" size="35" maxlength="10"/>
                                                    <a href="#" onclick="cal1x.showCalendar('anchor1x'); return false;"
                                                       name="anchor1x" id="anchor1x"><img
                                                                src="images/22x22/apps/calendar.png"
                                                                style="width: 16px; height: 16px; vertical-align: middle; position: relative; top: -2px; cursor: pointer;"
                                                                alt="<?php echo _("Calendar"); ?>"/></a>
                                                ...
                                                <input type="text" name="HC_datestart"
                                                       value="<?php echo $dateStart->getFormattedDate(DateUtil::FORMAT_MONTHLY); ?>"
                                                       class="width-form-button" size="35" disabled="disabled"/>
                                                <?php }
                                                }
                                                ?>
                                            </td>
                                        ...
                                        if ($charge->CH_period == Charge::PERIOD_MONTHLY) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name="HC_dateend"
                                                           value="<?php echo $dateEnd->getFormattedDate(DateUtil::FORMAT_MONTHLY); ?>"
                                                           class="width-form-button" size="35" maxlength="10"/>
                                                    <a href="#" onclick="cal2x.showCalendar('anchor2x'); return false;"

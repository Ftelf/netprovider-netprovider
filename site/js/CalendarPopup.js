...
function CalendarPopup() {
    ...
    c.monthAbbreviations = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    c.dayHeaders = ["S", "M", "T", "W", "T", "F", "S"];
    c.returnFunction = "CP_tmpReturnFunction";
    c.returnMonthFunction = "CP_tmpReturnMonthFunction";
    c.returnQuarterFunction = "CP_tmpReturnQuarterFunction";
    c.returnHalfFunction = "CP_tmpReturnHalfFunction";
    ...
    c.setReturnHalfFunction = CP_setReturnHalfFunction;
    ...
    c.setFireFunctionOnHide = CP_setFireFunctionOnHide;
    // Return the object
    return c;
}
...
function CP_tmpReturnHalfFunction(y, q) {
    alert('Use setReturnHalfFunction() to define which function will get the clicked results!\nYou clicked: year=' + y + ' , half=' + h);
}
...
function CP_setReturnHalfFunction(name) {
    this.returnHalfFunction = name;
}
...
// Set function that will be fired whed hide
function CP_setFireFunctionOnHide() {
    this.fireOnHideFunction = (arguments.length > 0) ? arguments[0] : "";
}

// Which type of calendar to display
function CP_setDisplayType(type) {
    if (type != "date" && type != "week-end" && type != "month" && type != "quarter" && type != "half" && type != "year") {
...
function CP_getCalendar() {
    ...
    if (this.displayType == "date" || this.displayType == "week-end") {
        ...
        for (var row = 1; row <= 6; row++) {
            ...
            for (var col = 1; col <= 7; col++) {
                ...
                if (disabled || this.disabledWeekDays[col - 1]) {
                    ...
                    result += '	<TD CLASS="' + this.cssPrefix + dateClass + '"><A HREF="javascript:' + windowref + this.returnFunction + '(' + selected_year + ',' + selected_month + ',' + selected_date + ');' + windowref + 'CP_hideCalendar(\'' + this.index + '\');' + this.fireOnHideFunction + '" CLASS="' + this.cssPrefix + dateClass + '">' + display_date + '</A></TD>\n';
                }
                display_date++;
        ...
        if (disabled || this.disabledWeekDays[current_weekday + 1]) {
            ...
            result += '		<A CLASS="' + this.cssPrefix + 'cpTodayText" HREF="javascript:' + windowref + this.returnFunction + '(\'' + now.getFullYear() + '\',\'' + (now.getMonth() + 1) + '\',\'' + now.getDate() + '\');' + windowref + 'CP_hideCalendar(\'' + this.index + '\');' + this.fireOnHideFunction + '">' + this.todayText + '</A>\n';
        }
        result += '		<BR>\n';
        result += '	</TD></TR></TABLE></CENTER></TD></TR></TABLE>\n';
    }

    // Code common for MONTH, QUARTER, HALF, YEAR
    // ------------------------------------
    if (this.displayType == "month" || this.displayType == "quarter" || this.displayType == "half" || this.displayType == "year") {
        if (arguments.length > 0) {
    ...
    // Code for HALF display
    // ------------------------
    if (this.displayType == "half") {
        result += '<BR><TABLE WIDTH=120 BORDER=1 CELLSPACING=0 CELLPADDING=0 ALIGN=CENTER>\n';
        result += '<TR>';
        for (var i = 0; i < 2; i++) {
            var half = (i + 1);
            result += '<TD WIDTH=50% ALIGN=CENTER><BR><A CLASS="' + this.cssPrefix + 'cpText" HREF="javascript:' + windowref + this.returnHalfFunction + '(' + year + ',' + half + ');' + windowref + 'CP_hideCalendar(\'' + this.index + '\');" CLASS="' + date_class + '">H' + half + '</A><BR><BR></TD>';
        }
        result += '</TR>';
        result += '</TABLE></CENTER></TD></TR></TABLE>\n';
    }
